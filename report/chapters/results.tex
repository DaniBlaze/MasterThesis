...
\begin{table}[ht]
\centering
\caption{Best Annualized Sharpe ratio after transaction costs - small vs large}
\resizebox{\textwidth}{!}{\begin{tabular}{l|c|cc|c}
\toprule
\textbf{Sharpe ratio} & \textbf{lstm1\_small} & \textbf{lstmi8\_large} & \textbf{lstm2\_large} & \textbf{Difference} \\ \midrule
\textbf{Long portfolio} & 1.92 & -1.62 & & 3.54 \\
\textbf{Long-short portfolio} & 2.17 & & -0.93 & 3.10 \\
\textbf{Short portfolio} & -0.16 & & -2.45 & 2.29 \\  \bottomrule
\end{tabular}}
\end{table}
